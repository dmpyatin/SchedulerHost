    ...
    public class MatrixLU 
    {
        ...
        *************************************************************************/
        public MatrixLU (double[,] a,int m,int n)
        {
            ...
            //
            if (n <= 1 | System.Math.Min(m, n) <= nb | nb == 1)
            {
            ...
            else
            {
                ...
                t = new double[n - 1 + 1];
                pivots = new int[System.Math.Min(m, n) - 1 + 1];
                minmn = System.Math.Min(m, n);
                j1 = 0;
                j2 = System.Math.Min(minmn, nb) - 1;
                ...
                while (j1 < minmn)
                {
                    ...
                    //
                    j1 = j2 + 1;
                    j2 = System.Math.Min(minmn, j1 + nb) - 1;
                }
            }
            result = a;
            result2 = pivots;
            ...
            ref int[] pivots)
        {
            ...
            pivots = new int[System.Math.Min(m - 1, n - 1) + 1];
            t1 = new double[System.Math.Max(m - 1, n - 1) + 1];
            ...
            for (j = 0; j <= System.Math.Min(m - 1, n - 1); j++)
            {
                ...
                for (i = j + 1; i <= m - 1; i++)
                {
                    if (System.Math.Abs(a[i, j]) > System.Math.Abs(a[jp, j]))
                    {
                        jp = i;
                    }
                }
