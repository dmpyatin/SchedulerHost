...
namespace Timetable.Math.Statistics
{
    ...
    public sealed class WeibullDistribution : ProbabilityDensityFunction
    {
        ...
        public void DefineParameters(double shape, double scale)
        {
            _alpha = shape;
            _beta = scale;
            _norm = _alpha / System.Math.Pow(_beta, _alpha);
        }
        ...
        {
            return 1.0 - System.Math.Exp(-System.Math.Pow(x / _beta, _alpha));
        }
        ...
        {
            return System.Math.Pow(-System.Math.Log(1 - x), 1.0 / _alpha) * _beta;
        }
        ...
        {
            return _norm * System.Math.Pow(x, _alpha - 1) * System.Math.Exp(-System.Math.Pow(x / _beta, _alpha));
        }
