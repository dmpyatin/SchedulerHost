...
namespace Timetable.Math.Statistics
{
    ...
    public sealed class CauchyDistribution : ProbabilityDensityFunction
    {
        ...
        {
            return System.Math.Atan((x - _mu) / _beta) / System.Math.PI + 0.5;
        }
        ...
        {
            return System.Math.Tan((x - 0.5) * System.Math.PI) * _beta + _mu;
        }
        ...
        {
            double dev = x - _mu;
            return _beta / (System.Math.PI * (_beta * _beta + dev * dev));
        }
