...
namespace Timetable.Math.Statistics
{
    ...
    public sealed class ExponentialDistribution : ProbabilityDensityFunction
    {
        ...
        {
            if (fallOff <= 0)
                throw new ArgumentOutOfRangeException(Resource.Exponential_fall_off_must_be_positive);
            _beta = fallOff;
        }
        ...
        public override double Average
        {
            ...
            set
            {
                throw new InvalidOperationException(Resource.Can_not_set_average_on_Exponential_distribution);
            }
        }
        ...
        {
            return 1 - System.Math.Exp(-x / _beta);
        }
        ...
        {
            get { return Resource.Exponential_distribution; }
        }
        ...
        {
            return System.Math.Exp(-x / _beta) / _beta;
        }
