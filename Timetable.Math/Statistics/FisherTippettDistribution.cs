...
namespace Timetable.Math.Statistics
{
    ...
    public sealed class FisherTippettDistribution : ProbabilityDensityFunction
    {
        ...
        {
            double t;
            while ((t = -System.Math.Log(this.Generator.NextDouble())) == 0) ;
            return _alpha - _beta * System.Math.Log(t);
        }
        ...
        {
            get { return System.Math.PI * _beta / System.Math.Sqrt(6); }
        }
        ...
        public override double Value(double x)
        {
            ...
            if (y > DhbMath.LargestExponentialArgument)
                return 0;
            return System.Math.Exp(-y) / _beta;
        }
