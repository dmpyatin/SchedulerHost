...
namespace Timetable.Math.Statistics
{
    ...
    public sealed class UniformDistribution : ProbabilityDensityFunction
    {
        ...
        {
            if (low >= high)
                throw new ArgumentOutOfRangeException(Resource.Limits_of_distribution_are_equal_or_reversed);
            _a = low;
            _b = high;
        }
        ...
        public override double Average
        {
            ...
            set
            {
                throw new InvalidOperationException(Resource.Can_not_set_average_on_Uniform_distribution);
            }
        }
