namespace Timetable.Math
{
    public class AllMethodText
    {
        ...
        /// </summary>
        public static string ApproximationBisection = @"
        ...
        public static string ApproximationChord = @"
        ...
        public static string ApproximationIterationmethod = @"
        ...
        public static string ApproximationNewton = @"
        ...
        /// </summary>
        public static string DifferentialEquationsEulerCorrected = @"
        ...
        public static string DifferentialEquationsEulerModified = @"
        ...
        public static string DifferentialEquationsEulerSimple = @"
        ...
        public static string DifferentialEquationsRungeKutta4 = @"
        ...
        /// Integration
        /// </summary>
        public static string IntegrationChebishev = @" 
        ...
        public static string IntegrationSimpson = @"
        ...
        public static string IntegrationSimpson2 = @"
        ...
        public static string IntegrationTrapezium = @"
        ...
        /// </summary>
        public static string SystemLinearEqualizationsGaus = @" 
        ...
        public static string SystemLinearEqualizationsZeidel = @"
        ...
        /// Matrix Algebra
        /// </summary>
        public static string MatrixAlgebraMatrixDeterminan = @"
        ...
        public static string MatrixAlgebraRMatrixLu = @"
        ...
        public static string MatrixAlgebraRMatrixLuInverse = @"
        ...
        /// NonLinear Equations
        /// </summary>
        public static string NonLinearEquationsHalfDivision = @"
        ...
        public static string NonLinearEquationsMetodHord = @"
        ...
        public static string NonLinearEquationsNewton = @"
        ...
        public static string NonLinearEquationsSecant = @"
        ...
        public Brent(FunctionOne f, double a, double b, double epsilon)
        {
            double ia = 0;
            double ib = 0;
            double bx = 0;
