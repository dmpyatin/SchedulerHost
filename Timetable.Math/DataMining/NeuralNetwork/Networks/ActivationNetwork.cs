...
namespace Timetable.Math.DataMining.NeuralNetwork.Networks
{
    /// <summary>
	/// Activation network
	/// </summary> 
	...
	public class ActivationNetwork : Network
	{
		...
		/// <remarks>The new network will be randomized (see <see cref="ActivationNeuron.Randomize"/> method) after it is created.</remarks> 
		...
		public ActivationNetwork( 
            ...
            int inputsCount, 
            params int[] neuronsCount ): base( inputsCount, neuronsCount.Length )
		{
			// create each layer
