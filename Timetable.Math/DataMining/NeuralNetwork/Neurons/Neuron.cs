...
namespace Timetable.Math.DataMining.NeuralNetwork.Neurons
{
    /// <summary>
	/// Base neuron class
	/// </summary> 
	...
	public abstract class Neuron
	{
		...
		/// <remarks>The new neuron will be randomized (see <see cref="Randomize"/> method) after it is created.</remarks>
		...
		/// Randomize neuron 
		/// </summary> 
		/// <remarks>Initialize neuron's weights with random values within the range specified by <see cref="RandRange"/>.</remarks> 
